 ...
 */
public class XSimpleGLRenderer implements XGLSurfaceView.Renderer {
	...
	private RapidBarCoordinate[] barCoordinate;
...
//	private int[] mCropWorkspace;
	...
	public XSimpleGLRenderer(Context context, DisplayMetrics metrics) {
...
//		mCropWorkspace = new int[4];
		...
		mContext = context;
		gameVariables = new GameVariables(context, metrics);
	}
	...
	public void setRapidCoord(RapidBarCoordinate[] coordinates){
		barCoordinate = coordinates;
	}
	...
	public void drawFrame(GL10 gl) {
		...
		if (mSprites != null) {
		   ...
		   //}
			...
			mSprites[0].setTranslatef(0.0f, 0.0f, 0.0f);
			mSprites[0].draw(gl);
			for(int x = 0 ; x < 5 ; x++){
				if( barCoordinate[x].type == 1 ){
					mSprites[1].setTranslatef(barCoordinate[x].x,barCoordinate[x].y, 0.0f);
					mSprites[1].draw(gl);
				}
				else{
					mSprites[2].setTranslatef(barCoordinate[x].x,barCoordinate[x].y, 0.0f);
					mSprites[2].draw(gl);
				}
			}
