...
public class GameOverTexture
{
	...
	/*Begin Methods*/
	public GameOverTexture( GL10 gl_obj , Context mContext)
	{
		gl = gl_obj;
		texture = new int[1];
		...
		InputStream red = mContext.getResources().openRawResource(R.drawable.game_over_01);
