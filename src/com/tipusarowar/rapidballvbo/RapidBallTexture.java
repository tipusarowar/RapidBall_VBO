...
public class RapidBallTexture
{
	...
	/*Begin Methods*/
	public RapidBallTexture( GL10 gl_obj , Context mContext)
	{
		gl = gl_obj;
		texture = new int[1];
		...
		InputStream red = mContext.getResources().openRawResource(R.drawable.rapid_ball);
